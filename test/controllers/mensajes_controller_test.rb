...
class MensajesControllerTest < ActionController::TestCase
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post :create, mensaje: { asunto: @mensaje.asunto, consulta: @mensaje.consulta, user_id: @mensaje.user_id }
    end
  ...
  test "should update mensaje" do
    patch :update, id: @mensaje, mensaje: { asunto: @mensaje.asunto, consulta: @mensaje.consulta, user_id: @mensaje.user_id }
    assert_redirected_to mensaje_path(assigns(:mensaje))
  end
