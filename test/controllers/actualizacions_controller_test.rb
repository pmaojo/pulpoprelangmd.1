...
class ActualizacionsControllerTest < ActionController::TestCase
  ...
  test "should create actualizacion" do
    assert_difference('Actualizacion.count') do
      post :create, actualizacion: { cardio: @actualizacion.cardio, dieta: @actualizacion.dieta, muscular: @actualizacion.muscular, peso: @actualizacion.peso, talla: @actualizacion.talla, user_id: @actualizacion.user_id }
    end
  ...
  test "should update actualizacion" do
    patch :update, id: @actualizacion, actualizacion: { cardio: @actualizacion.cardio, dieta: @actualizacion.dieta, muscular: @actualizacion.muscular, peso: @actualizacion.peso, talla: @actualizacion.talla, user_id: @actualizacion.user_id }
    assert_redirected_to actualizacion_path(assigns(:actualizacion))
  end
